...
### Full Product Export/Import (v2.0)
...
1. Download `com_j2commerce_importexport_2.x.x.zip`
...
### v2.0.0 (January 2026)
- Full product export with all related data
- Full product import with automatic article/category creation
- Menu item creation during import
- Access level configuration for menu items
- Tags and custom fields support
- Metafields support
- Improved UI with collapsible options

### v1.0.0 (December 2025)
- Initial release
- Basic product/variant/price import/export
...
Proprietary. Copyright (C) 2025-2026 Advans IT Solutions GmbH.
