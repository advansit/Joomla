...
class InstallationTest
{
    ...
    private function testPluginRegistered()
    {
        $query = $this->db->getQuery(true)
            ...
            ->where($this->db->quoteName('element') . ' = ' . $this->db->quote('acymailing'))
    ...
    {
        $files = [
            '/var/www/html/administrator/components/acymailing/j2store_cleanup.php',
        ];
    ...
    private function testLanguageFiles()
    {
        ...
        foreach ($languages as $lang) {
            $file = "/var/www/html/administrator/language/$lang/acymailing.ini";
            if (file_exists($file)) {
                $found++;
                echo "  ✓ Language: $lang\n";
            }
